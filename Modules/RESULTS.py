...
class results(object):
    ...
    def plot_1column_network_digraph(self, DF_column = '', max_circle_size = 100, min_circle_size = 10, min_occurrences = 0, graph_base_title = '',
        ...
        #agrupando a DF (gera um objeto GROUPBY com multiindex)
        grouped = filtered_series.groupby(DF_column)
        ...
        #varrendos as entradas para cada artigo
...
def find_heaviest_path(G, start = None, end=None, network_type='directed', network_name = ''):
    ...
    if start is not None:
        ...
        _, _, heaviest_path_weight, all_heaviest_path, close_path = search_out_nodes(G, start, end_node = end, path = [start], max_weight=0, heaviest_path=[], cum_path_weights=[])    
    ...
    #percorrendo todos os possíveis caminhos        
        ...
        for in_node in G.nodes():
            ...
            print('Network: ', network_name)
            print('Start node: ', start)
            _, _, max_weight, heaviest_path, close_path = search_out_nodes(G, in_node, end_node = end, path = [in_node], max_weight=0, heaviest_path=[], cum_path_weights=[])
