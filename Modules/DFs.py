...
class DataFrames(object):
    ...
    def extract_numerical_parameters(self, text, text_index, parameter, extract_mode = 'first'):
        ...
        extracted_dic = self.extract_from_sent_first_parameter_sec_numbers(text, text_index, parameter, parameters_patterns, extract_mode = extract_mode)
        ...
        if extracted_dic['num_output'] is None and parameters_patterns['parameters_pattern_to_find_in_sent'] is not None:
            extracted_dic = self.extract_from_sent_first_numbers_sec_parameters(text, text_index, parameter, parameters_patterns, extract_mode = extract_mode)
    ...
    def extract_from_sent_first_parameter_sec_numbers(self, text, text_index, parameter, parameters_patterns, extract_mode = 'all'):
        ...
        while True:
            ...
            if parameters_patterns['parameters_pattern_to_find_in_sent'] is not None:
                ...
                if match_parameters_to_find:
                    ...
                    if match_next_parameters_to_find:
                        ...
                        #print('text after next parameter found: ', text[ cumulative_cut_numbers + matches_end + match_next_parameters_to_find.span()[1] : ])
            ...
            #caso tenha que encontrar o parâmetro e ele foi encontrado
                ...
                n_numbers_matches_to_find = len(parameters_extracted_from_sent)
                total_n_numbers_to_extract += n_numbers_matches_to_find * 2
            ...
            while True:
                ...
                if match_numbers_to_find:
                    ...
                    if inner_matches < n_numbers_matches_to_find and cumulative_cut <= next_parameter_index:
                        ...
                        inner_matches += 1
                        #atualizando o n_numbers_matches_to_find
                        #n_numbers_matches_to_find -= 1
                        #atualizando o local_cumulative_cut para a proxima varredura dentro do inner while
                        local_cumulative_cut = cumulative_cut_numbers
                    ...
                    #saindo do inner                        
                        ...
                        #acrescentando um index para não ficar em looping infinito
    ...
    def extract_from_sent_first_numbers_sec_parameters(self, text, text_index, parameter, parameters_patterns, extract_mode = 'all'):
        ...
        while True:
            ...
            if match_parameters_to_find:
                ...
                #determinando o index do proximo parâmetro na sentença
                if match_next_parameters_to_find:
                    #print('text after next parameter found: ', text[ cumulative_cut_parameters + matches_end + match_next_parameters_to_find.span()[1] : ])
                    pass
            ...
            while True:
                ...
                if match_numbers_to_find:
                    ...
                    #caso ainda haja number para procurar
                    if inner_matches < n_numbers_matches_to_find and cumulative_cut <= cumulative_cut_parameters:
