...
def check_memory_use(memory_used):
    ...
    print('Memory usage - used (%): ', round( ( current_memory_used['ram'] / memory_used['ram'] ) * 100, 2), ' %')
    print('Memory usage - buffers (%): ', round( ( current_memory_used['buffers'] / memory_used['buffers'] ) * 100, 2), ' %')
    print('Memory usage - cached (%): ', round( ( current_memory_used['cached'] / memory_used['cached'] ) * 100, 2), ' %')
