...
graph_results_1 = results.analyze_1column_network_digraph(DF_column = 'processes', max_circle_size = 90, min_circle_size = 50, min_occurrences = 4, graph_base_title = 'H/C 1',
                                                    start_end_nodes_to_analyze = ['pyrolysis'], path_nodes_cutoff = 5, min_edge_weight = 0.4,
...
graph_results_2 = results.analyze_1column_network_digraph(DF_column = 'processes', max_circle_size = 90, min_circle_size = 50, min_occurrences = 4, graph_base_title = 'H/C 2',
                                                    start_end_nodes_to_analyze = ['pyrolysis'], path_nodes_cutoff = 5, min_edge_weight = 0.4,
                                                    plot_graphs = False, print_unique_vals_in_DF = False)
...
graph_results_5 = results.analyze_1column_network_digraph(DF_column = 'processes', max_circle_size = 60, min_circle_size = 30, min_occurrences = 5, graph_base_title = 'SA 1',
                                                    start_end_nodes_to_analyze = ['pyrolysis'], path_nodes_cutoff = 11, min_edge_weight = 0.6,
                                                    plot_graphs = False, print_unique_vals_in_DF = False)
...
graph_results_6 = results.analyze_1column_network_digraph(DF_column = 'processes', max_circle_size = 60, min_circle_size = 30, min_occurrences = 5, graph_base_title = 'SA 2',
                                                    start_end_nodes_to_analyze = ['pyrolysis'], path_nodes_cutoff = 11, min_edge_weight = 0.6,
                                                    plot_graphs = False, print_unique_vals_in_DF = False)
...
graph_results_7 = results.analyze_1column_network_digraph(DF_column = 'processes', max_circle_size = 60, min_circle_size = 30, min_occurrences = 5, graph_base_title = 'SA 3',
                                                    start_end_nodes_to_analyze = ['pyrolysis'], path_nodes_cutoff = 11, min_edge_weight = 0.6,
                                                    plot_graphs = False, print_unique_vals_in_DF = False)
'''
#instanciando o DataFrame consolidado
...
graph_results_8 = results.analyze_1column_network_digraph(DF_column = 'processes', max_circle_size = 60, min_circle_size = 30, min_occurrences = 5, graph_base_title = 'SA 4',
                                                    start_end_nodes_to_analyze = ['pyrolysis'], path_nodes_cutoff = 11, min_edge_weight = 0.6,
                                                    plot_graphs = False, print_unique_vals_in_DF = False)
'''
#Fig34
...
results.plot_group_num_boxplot_correlation(DF_column_with_cat_vals = 'raw_materials',
                                           ...
                                           column_cat_to_filter = 'surface_area',
...
#instanciando o DataFrame consolidado
from RESULTS import results
results = results(results_DF_input_name = 'process_P0042_G2_FULL_DF')
graph_results_9 = results.analyze_1column_network_digraph(DF_column = 'processes', max_circle_size = 60, min_circle_size = 30, min_occurrences = 4, graph_base_title = 'Peanut shell',
                                                    start_end_nodes_to_analyze = ['pyrolysis'], path_nodes_cutoff = 11, min_edge_weight = 0.3,
                                                    plot_graphs = False, print_unique_vals_in_DF = False)
...
#instanciando o DataFrame consolidado
from RESULTS import results
results = results(results_DF_input_name = 'process_P0042_G5_FULL_DF')
graph_results_10 = results.analyze_1column_network_digraph(DF_column = 'processes', max_circle_size = 60, min_circle_size = 30, min_occurrences = 1, graph_base_title = 'Rice straw',
                                                    start_end_nodes_to_analyze = ['pyrolysis'], path_nodes_cutoff = 11, min_edge_weight = 0.0,
                                                    plot_graphs = False, print_unique_vals_in_DF = False)

#Fig52
from RESULTS import groups_results
grop_results = groups_results(graph_results_9, graph_results_10)
grop_results.bar_plot(maximum_values_to_plot = 15)
...
results.plot_grouped_filtered_cat_boxplot(column_to_group = 'raw_materials', 
                                          category_to_analyze = 'rice straw',
                                          columns_with_num_vals_to_filter = ['surface_area', 'H#C'],
                                          min_max_vals_to_filter = [[100, 1500], [0, 200]],
                                          ymin_ymax_list = [[0, 1000], [0, 1000], [0, 1000]], 
                                          x_axis_label = '', 
